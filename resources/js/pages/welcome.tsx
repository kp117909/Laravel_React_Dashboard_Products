...
import { createWelcomeFilterChecker, clearAllFilters, updateFilters } from '@/utils/welcome-utils';
...
export default function Welcome({ products, categories, filters, years, priceRange, categoryCounts, yearCounts, availabilityCounts }: Props) {
  ...
  const filterChecker = useMemo(() =>
    createWelcomeFilterChecker(filters, years, allCategoryIds, priceRange),
